...
type Controller interface {
	...
	// OnUpdate callback invoked from the sync queue https://k8s.io/ingressl4/core/blob/master/pkg/ingress/controller/controller.go#L387
	...
	// https://k8s.io/ingressl4/core/blob/master/pkg/ingress/types.go#L83
